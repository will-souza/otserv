...
local mountName = string.lower(mounts[choice.id].name) 
-- Converts the mount name to lowercase    
...
self:sendTextMessage(MESSAGE_EVENT_ADVANCE, "You can now use the " ..mountName.. " mount!")    end   
-- Modal window design    
